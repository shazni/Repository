 ...
 * @deprecated
 * 
 * This is been in registry for so long. But as this is not something related to repository
 * this will be eventually moved out from the carbon kernel
 * 
 * Aspects are using to associate custom behaviors with resources; Aspects differ from handlers, in
...
public abstract class Aspect {
     ...
     */
    public abstract void associate(Resource resource, Registry registry) throws RepositoryException;
     ...
     *          If the condition is not met or some thing is wrong
     */
    public abstract void invoke(RequestContext context, String action) throws RepositoryException;
     ...
     *          If the condition is not met or some thing is wrong
     */
    public void invoke(RequestContext context, String action, Map<String, String> parameters) throws RepositoryException {
