...
public abstract class Handler {
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the put on the
     ...
     *                       imported content.
     *
     * @throws RepositoryException If the media type handler is supposed to handle the import on the
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the delete on the
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the putChild on the
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the importChild on
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the invokeAspect on
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the addAssociation
     ...
     *                       requestContext.associationType: Type of Association
     *
     * @throws RepositoryException If the media type handler is supposed to handle the
     ...
     *         action successfully.
     * @throws RepositoryException If the media type handler is supposed to handle the getAssociations
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the applyTag on the
     ...
     *                       Path of Resource requestContext.tag: Tag
     *
     * @throws RepositoryException If the media type handler is supposed to handle the removeTag on
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the rateResource on
     ...
     *
     * @throws RepositoryException If the media type handler is supposed to handle the editComment on
     ...
     *         successfully.
     * @throws RepositoryException If the media type handler is supposed to handle the addComment on
     ...
     * @throws RepositoryException If the media type handler is supposed to handle the getComments on
     ...
     *         successfully.
     * @throws RepositoryException If the media type handler is supposed to handle the getRating on
     ...
     *         action successfully.
     * @throws RepositoryException If the media type handler is supposed to handle the getTags on the
