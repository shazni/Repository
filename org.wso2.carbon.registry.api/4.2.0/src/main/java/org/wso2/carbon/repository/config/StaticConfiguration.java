...
package org.wso2.carbon.repository.config;
...
public class StaticConfiguration {
    ...
    /**
     * Method to set the registryRoot
     * 
     * @param registryRootVal registry root value
     */
    public static void setRegistryRoot(String registryRootVal) {
    	registryRoot = registryRootVal ;
    }
    
    /**
     * Method to get the registry root
     * 
     * @return configured registry root
     */
