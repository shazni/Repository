...
/**
 * Representation of a activity that has been performed on the repository. For example, a put
 * operation will lead to activity of adding a resource into the repository, or updating an existing
 * resource on the repository. Each activity performed on the repository will have a corresponding log
