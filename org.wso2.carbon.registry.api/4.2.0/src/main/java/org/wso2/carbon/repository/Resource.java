...
/**
 * Interface to represent a resource that is stored on the repository. Each resource will have some
 * metadata and content. Resources can also have properties, and versions.
 * <p/>
 * In addition to that, the repository APIs can be used to create associations between resources, rate
