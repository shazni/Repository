...
public class Worker3 extends Worker {
    ...
    public Worker3(String threadName, int iterations, Repository registry) {
        ...
        try {
            ...
            q1.addProperty(RepositoryConstants.RESULT_TYPE_PROPERTY_NAME, RepositoryConstants.RATINGS_RESULT_TYPE);
