...
public interface ResourceDAO {
     ...
     * @throws RepositoryException throws the retrieval of resource id failed
     */
    ResourceIDImpl getResourceID(String path, boolean isCollection) throws RepositoryException;
     ...
     * @throws RepositoryException throws if resource retrieval failed.
     */
    CollectionImpl get(ResourceIDImpl resourceID, int start, int pageLen) throws RepositoryException;
     ...
     * @throws RepositoryException throws if resource filling failed.
     */
    void fillResource(CollectionImpl collection, int start, int pageLen) throws RepositoryException;
     ...
     */
    void fillResourcePropertiesWithNoUpdate(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed
     */
    void addRoot(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed
     */
    void add(String path, ResourceIDImpl parentID, ResourceImpl resourceImpl) throws RepositoryException;
     ...
     */
    void createAndApplyResourceID(String path, ResourceIDImpl parentID, ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException throws if operation failed.
     */
    ResourceIDImpl createResourceID(String path, ResourceIDImpl parentID, boolean isCollection) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    int getChildCount(CollectionImpl collection, DataAccessManager dataAccessManager) throws RepositoryException;
     ...
     */
    void fillChildren(CollectionImpl collection, int start, int pageLen) throws RepositoryException;
     ...
     * @throws RepositoryException if the operation failed.
     */
    void fillChildren(CollectionImpl collection, DataAccessManager dataAccessManager) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    String[] getChildren(CollectionImpl collection, int start, int pageLen, DataAccessManager dataAccessManager) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    String[] getChildren(CollectionImpl collection, int start, int pageLen) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    ResourceImpl getResourceWithNoUpdate(ResourceIDImpl resourceID) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void fillResourceContentWithNoUpdate(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void updateCollectionLastUpdatedTime(ResourceIDImpl resourceID) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void updateContentId(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void addResourceWithoutContentId(ResourceImpl resourceImpl, boolean isUpdatingExisting) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void addResourceWithNoUpdate(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void addResourceDO(ResourceDO resourceDO) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    List<ResourceIDImpl> getChildPathIds(ResourceIDImpl resourceID) throws RepositoryException;
     ...
     * @throws RepositoryException if the operation failed.
     */
    String getPath(int pathId, String resourceName, boolean checkExistence) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void moveResources(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void moveResourcePaths(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void moveProperties(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException;
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    void movePropertyPaths(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException;
}
