...
public final class RepositoryConstants {
	 ...
	 * governance repositories are kept.
	 */
	...
	/**
	 * The base path for the config repository.
	 */
    ...
    */
	...
	/**
	 * The path to store repository configurations.
	 */
	...
	/**
	 * The path to store the life-cycle configurations.
	 */
