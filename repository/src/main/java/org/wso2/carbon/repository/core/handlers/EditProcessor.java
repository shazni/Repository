...
public abstract class EditProcessor {
     ...
     * @throws RepositoryException if an error occurs while processing content.
     */
    public abstract boolean processEditContent(String path, String editViewKey,
    											HttpServletRequest request, HttpServletResponse response) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurs while processing content.
     */
    public abstract boolean processNewContent(String parentPath, String newViewKey,
            									HttpServletRequest request, HttpServletResponse response) throws RepositoryException;
     ...
     */
    protected Repository getRegistry(HttpServletRequest request) throws RepositoryException {
        Repository registry = (Repository) request.getSession().getAttribute(RepositoryConstants.ROOT_REGISTRY_INSTANCE);

        if (registry == null) {
            registry = RepositoryServiceComponent.getRepositoryService().getRepository();
        }
