...
import org.wso2.carbon.repository.core.exceptions.RepositoryConcurrentModificationException;
...
public class JDBCResourceDAO implements ResourceDAO {
    ...
    public ResourceIDImpl getResourceID(String path) throws RepositoryException {
        ...
        try {
            ...
            if (!isCollection) {
                ...
                resourceName = RepositoryUtils.getResourceName(path);
            ...
            log.error(msg, e);
            throw new RepositoryResourceNotFoundException(msg, e, RepositoryErrorCodes.RESOURCE_PATH_ERROR);
        }

        return null;
    }

    public ResourceIDImpl getResourceID(String path, boolean isCollection) throws RepositoryException {
    ...
    public boolean resourceExists(ResourceIDImpl resourceID) throws RepositoryException {
    ...
    public boolean resourceExists(String path, boolean isCollection) throws RepositoryException {
        ResourceIDImpl resourceID = getResourceID(path, isCollection);
        return resourceID != null && resourceExists(resourceID);
    }

    public long getVersion(ResourceIDImpl resourceID) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn =
                JDBCDatabaseTransaction.getConnection();
        ...
        try {
            if (resourceID.isCollection()) {
                String sql = "SELECT REG_VERSION FROM REG_RESOURCE WHERE REG_PATH_ID=? AND REG_NAME IS NULL AND REG_TENANT_ID=?";
                ...
                String sql = "SELECT REG_VERSION FROM REG_RESOURCE WHERE REG_PATH_ID=? AND REG_NAME=? AND REG_TENANT_ID=?";
    ...
    public ResourceImpl get(String path) throws RepositoryException {
        ResourceIDImpl resourceID = getResourceID(path);
    ...
    public ResourceImpl get(ResourceIDImpl resourceID) throws RepositoryException {
    ...
    public CollectionImpl get(String path, int start, int pageLen) throws RepositoryException {
        ResourceIDImpl resourceID = getResourceID(path);
    ...
    public void fillResource(ResourceImpl resourceImpl) throws RepositoryException {
        if (resourceImpl == null) {
            throw new RepositoryException("Unable to fill null resource");
        }
        ...
        if (!(resourceImpl instanceof CollectionImpl) &&
			...
			if (resourceImpl instanceof CollectionImpl) {
				int tempTenantId = CurrentContext.getTenantId();
    ...
    public void fillResource(CollectionImpl collection, int start, int pageLen) throws RepositoryException {
        fillChildren(collection, start, pageLen);
        fillResourcePropertiesWithNoUpdate(collection);
    }

    public void fillResourcePropertiesWithNoUpdate(ResourceImpl resourceImpl) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
        ResultSet results = null;
        try {
            if (StaticConfiguration.isVersioningProperties()) {
                String propSQL = SELECT_NAME_VALUE_PROP_P +
    ...
    public void fillResourceProperties(ResourceImpl resourceImpl) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
        ResultSet results = null;
        try {
    ...
    public void addRoot(ResourceImpl resourceImpl) throws RepositoryException {
    ...
    public void add(String path, ResourceIDImpl parentID, ResourceImpl resourceImpl) throws RepositoryException {
    ...
    public void createAndApplyResourceID(String path, ResourceIDImpl parentID, ResourceImpl resourceImpl) throws RepositoryException {
        ResourceIDImpl resourceID = createResourceID(path, parentID, resourceImpl instanceof CollectionImpl);
    ...
    public ResourceIDImpl createResourceID(String path, ResourceIDImpl parentID, boolean isCollection) throws RepositoryException {
        ResourceIDImpl resourceID = new ResourceIDImpl();
        ...
        try {
            ...
            if (isCollection) {
                ...
                String resourceName = RepositoryUtils.getResourceName(path);
                resourceID.setName(resourceName);
                resourceID.setPath(path);
    ...
    public void deleteContentStream(int contentID) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
    ...
    public InputStream getContentStream(int contentID) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
        ResultSet result = null;
        ...
        try {
            ...
            if (result.next()) {
                ...
                if (rawInputStream != null) {
                    return RepositoryUtils.getMemoryStream(rawInputStream);
                }
            }
        } catch (SQLException ex) {
            String msg = InternalConstants.RESULT_SET_PREPARED_STATEMENT_CLOSE_ERROR;
    ...
    public void update(ResourceImpl resourceImpl) throws RepositoryException {
    ...
    public int getChildCount(CollectionImpl collection, DataAccessManager dataAccessManager) throws RepositoryException {
        int childCount = -1;
     ...
     */
    public int getChildCount(CollectionImpl collection, Connection conn) throws RepositoryException {
        ...
        try {
            ...
            ps2.setInt(3, CurrentContext.getTenantId());
    ...
    public void fillChildren(CollectionImpl collection, int start, int pageLen) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        fillChildren(collection, start, pageLen, conn);
    }

    public void fillChildren(CollectionImpl collection, DataAccessManager dataAccessManager) throws RepositoryException {
        if (Transaction.isStarted()) {
     ...
     */
    public void fillChildren(CollectionImpl collection, int start, int pageLen, Connection conn) throws RepositoryException {
    ...
    public String[] getChildren(CollectionImpl collection, int start, int pageLen, DataAccessManager dataAccessManager) throws RepositoryException {
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    public String[] getChildren(CollectionImpl collection, int start, int pageLen, Connection conn) throws RepositoryException {
        ResourceIDImpl resourceID = collection.getResourceIDImpl();
        ResultSet results1 = null;
        PreparedStatement ps1 = null;
        ResultSet results2 = null;
        ...
        try {
            ...
            while (results1.next()) {
                ...
                String childPath = parentPath + (parentPath.equals(RepositoryConstants.PATH_SEPARATOR) ? "" : RepositoryConstants.PATH_SEPARATOR) + childName;
            ...
            if (totalSize < start) {
                throw new RepositoryDBException("Didn't have enough results to start at #" + start);
            }
    ...
    public String[] getChildren(CollectionImpl collection, int start, int pageLen) throws RepositoryException {
        return getChildren(collection, start, pageLen, JDBCDatabaseTransaction.getConnection());
    }

    public ResourceImpl getResourceMetaData(String path) throws RepositoryException {
    ...
    public ResourceImpl getResourceMetaData(ResourceIDImpl resourceID) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        ...
        try {
            ...
            if (result.next()) {
                ...
                resourceImpl.setCreatedTime(result.getTimestamp(DatabaseConstants.CREATED_TIME_FIELD));
                resourceImpl.setLastUpdaterUserName(result.getString(DatabaseConstants.LAST_UPDATER_FIELD));
                resourceImpl.setLastModified(result.getTimestamp(DatabaseConstants.LAST_UPDATED_TIME_FIELD));
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    private ResourceImpl getResource(ResourceIDImpl resourceID) throws RepositoryException {
    ...
    public ResourceImpl getResourceWithNoUpdate(ResourceIDImpl resourceID) throws RepositoryException {
        ResourceImpl resourceImpl = getResourceMetaData(resourceID);
    ...
    public void fillResourceContent(ResourceImpl resourceImpl) throws RepositoryException {
    ...
    public void fillResourceContentWithNoUpdate(ResourceImpl resourceImpl) throws RepositoryException {
        int contentId = resourceImpl.getDbBasedContentID();
        InputStream contentStream = getContentStream(contentId);
        if (contentStream == null) {
    ...
    public void updateCollectionLastUpdatedTime(ResourceIDImpl resourceID) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
        ...
        try {
            ...
            if (msg.toLowerCase().contains("lock")) {
                ...
                // separately.
                throw new RepositoryConcurrentModificationException(msg, e);
            } else {
                throw new RepositoryDBException(msg, e);
            }
        } finally {
    ...
    public void updateContentId(ResourceImpl resourceImpl) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
    ...
    public void addResourceWithoutContentId(ResourceImpl resourceImpl, boolean isUpdatingExisting) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
        PreparedStatement ps1 = null;
        ResultSet result = null;
    ...
    public void addResourceWithNoUpdate(ResourceImpl resourceImpl) throws RepositoryException {
    ...
    public void deleteResource(ResourceDO resourceDO) throws RepositoryException {
        ...
        try {
            if (resourceDO.getName() == null) {
                ...
                String sql = "DELETE FROM REG_RESOURCE WHERE REG_PATH_ID=? AND REG_NAME=? AND REG_TENANT_ID=?";
    ...
    public void addProperties(ResourceImpl resource) throws RepositoryException {
        ...
        if (isVersioningProperties) {
            sql3 = "INSERT INTO REG_RESOURCE_PROPERTY (REG_PROPERTY_ID, REG_VERSION, REG_TENANT_ID) VALUES (?, ?, ?)";
        } else {
            sql3 = "INSERT INTO REG_RESOURCE_PROPERTY (REG_PROPERTY_ID, REG_PATH_ID, REG_RESOURCE_NAME, REG_TENANT_ID) VALUES (?, ?, ?, ?)";
        }

        ResourceIDImpl resourceID = resource.getResourceIDImpl();

        for (Object nameObj : resource.getPropertyKeys()) {
            String name = (String) nameObj;
            List propValues = (List) resource.getPropertyValues(name);
            if (propValues != null) {
                for (Object valueObj : propValues) {
                    ...
                    try {
                        ...
                        ps1.setInt(3, CurrentContext.getTenantId());
                        if (returnsGeneratedKeys) {
                            ps1.executeUpdate();
                        ...
                        if (resultSet1.next()) {
                            ...
                            if (isVersioningProperties) {
                                ...
                                ps3.setInt(3, CurrentContext.getTenantId());
                            } else {
                                ...
                                ps3.setInt(4, CurrentContext.getTenantId());
                            }
                            ps3.executeUpdate();
                        }
                    } catch (SQLException e) {
     ...
     * @throws RepositoryException throws if the operation failed.
     */
    private Integer[] getPropertyIds(ResourceDO resourceDO) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
    ...
    public void addContent(ResourceImpl resourceImpl) throws RepositoryException {
    ...
    public int addContentBytes(InputStream contentStream) throws RepositoryException {
        ...
        try {
            ...
            if (returnsGeneratedKeys) {
                ps = conn.prepareStatement(sql, new String[]{DBUtils.getConvertedAutoGeneratedColumnName(dbProductName, "REG_CONTENT_ID")});
            } else {
                ps = conn.prepareStatement(sql);
            }
    ...
    public ResourceDO getResourceDO(long version) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
        ResultSet result = null;
        try {
            ...
            if (result.next()) {
                ...
                resourceDO.setCreatedOn(result.getTimestamp(DatabaseConstants.CREATED_TIME_FIELD).getTime());
                resourceDO.setLastUpdater(result.getString(DatabaseConstants.LAST_UPDATER_FIELD));
                resourceDO.setLastUpdatedOn(result.getTimestamp(DatabaseConstants.LAST_UPDATED_TIME_FIELD).getTime());
    ...
    public ResourceDO getResourceDO(ResourceIDImpl resourceID) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
        ResultSet result = null;
        try {
    ...
    public String getPathFromId(int pathId) throws RepositoryException {
        try {
    ...
    public String getPath(long version) throws RepositoryException {
    ...
    public String getPath(int pathId, String resourceName, boolean checkExistence) throws RepositoryException {
        ...
        } else if (pathCollection.equals(RepositoryConstants.ROOT_PATH)) {
            correctPath = pathCollection + resourceName;
        } else {
            correctPath = pathCollection + RepositoryConstants.PATH_SEPARATOR + resourceName;
        }
    ...
    public void moveResources(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
        ...
        try {
            if (source.isCollection()) {
                ...
                ps.setInt(5, CurrentContext.getTenantId());
                ps.executeUpdate();
            }
        } catch (SQLException e) {
    ...
    public void moveResourcePaths(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException {
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        PreparedStatement ps = null;
    ...
    public void moveProperties(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException {
        if (StaticConfiguration.isVersioningProperties()) {
            return;
        }
        JDBCDatabaseTransaction.ManagedRegistryConnection conn = JDBCDatabaseTransaction.getConnection();
        ...
        try {
            if (source.isCollection()) {
                ...
                String sql = "UPDATE REG_RESOURCE_PROPERTY SET REG_PATH_ID=?, REG_RESOURCE_NAME=? " +
    ...
    public void movePropertyPaths(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException {
        if (StaticConfiguration.isVersioningProperties()) {
            return;
        }
