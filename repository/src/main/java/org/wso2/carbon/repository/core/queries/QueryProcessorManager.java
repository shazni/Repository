...
package org.wso2.carbon.repository.core.queries;
...
import org.wso2.carbon.repository.core.config.QueryProcessorConfiguration;
...
public class QueryProcessorManager {
     ...
     */
    public QueryProcessorManager(DataAccessManager dataAccessManager, RepositoryContext registryContext) throws RepositoryException {
        queryProcessors.put(RepositoryConstants.SQL_QUERY_MEDIA_TYPE, dataAccessManager.getQueryProcessor());
        ...
        if (registryContext != null) {
            for (Object queryProcessorObject : registryContext.getQueryProcessors()) {
                ...
                try {
                    ...
                    String msg = "Could not find the query processor class for query type: " + configuration.getQueryType();
                    throw new RepositoryConfigurationException(msg, e);
                } catch (Exception e) {
                    String msg = "Failed to initiate query processor for query type: " + configuration.getQueryType();
     ...
     * @throws RepositoryException throws if the query execution failed.
     */
    public Collection executeQuery(Repository registry, Resource queryResource, Map parameters) throws RepositoryException {
        ...
        QueryProcessor queryProcessor = queryProcessors.get(queryResource.getMediaType());
