 ...
 * Repository#get(String)} method invocation using this path gives an instance of that resource. This
...
public class ResourceImpl implements org.wso2.carbon.repository.api.Resource {
    ...
    /**
     * Normal resources have the state RepositoryConstants.ACTIVE_STATE (100) Deleted resources have
     * the state RepositoryConstants.DELETED_STATE (101)
     */
    protected int state;
    ...
    public ResourceImpl() {
        if (RepositoryContext.getBaseInstance() != null) {
            this.dataAccessManager = RepositoryContext.getBaseInstance().getDataAccessManager();
        } else {
    ...
    public InputStream getContentStream() throws RepositoryException {
        ...
        if (content instanceof byte[]) {
            ...
            byte[] contentBytes = RepositoryUtils.encodeString(((String) content));
            return new ByteArrayInputStream(contentBytes);
        } else if (content instanceof InputStream) {
            return (InputStream) content;
        } else {
            throw new RepositoryServerContentException("Cannot return input stream for content of type: " + content.getClass().getName());
        }
    }
     ...
     */
    protected void clearContextInformation() {
