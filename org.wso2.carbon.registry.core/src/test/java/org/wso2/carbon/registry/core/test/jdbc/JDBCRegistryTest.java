...
//        	embeddedRegistryService.init(ctx);
    ...
    public void testCollectionDetails() throws Exception {
        ...
        inContent.close();
        assertEquals(str, RepositoryUtils.decodeBytes(outStream.toByteArray()));
        r1.discard();
    }
    ...
    public void testFlatResourceHandling() throws RepositoryException {
        ...
        assertEquals("Content is not equal.",
                RepositoryUtils.decodeBytes((byte[])r1.getContent()),
                RepositoryUtils.decodeBytes((byte[])r1f.getContent()));
    ...
    public void testHierarchicalResourceHandling() throws Exception {
        ...
        assertTrue("/d1 should be a collection.",
                d1 instanceof org.wso2.carbon.repository.Collection);
...
//        boolean isVersionOnChange = ((EmbeddedRegistry) registry).getRegistryContext().isVersionOnChange();
        Resource r1 = registry.newResource();
    ...
    public void testComments() throws Exception {
        ...
        registry.addComment("/d12/r1", new CommentImpl(comment1));
        registry.addComment("/d12/r1", new CommentImpl(comment2));
        ...
        comments = (CommentImpl[])commentsResource.getContent();
    ...
    public void testUserDefinedResourceQuery() throws Exception {
        ...
        q1.addProperty(RepositoryConstants.RESULT_TYPE_PROPERTY_NAME,
                RepositoryConstants.RESOURCES_RESULT_TYPE);
        ...
        assertTrue("Search with result type Resource should return a directory.",
                result instanceof org.wso2.carbon.repository.Collection);
    ...
    public void testUserDefinedRatingsQuery() throws Exception {
        ...
        q1.setMediaType(RepositoryConstants.SQL_QUERY_MEDIA_TYPE);
        q1.addProperty(RepositoryConstants.RESULT_TYPE_PROPERTY_NAME,
                RepositoryConstants.RATINGS_RESULT_TYPE);
...
//                rating2.getContent().toString(), "4");
    ...
    public void testUserDefinedCommentsQuery() throws Exception {
        ...
        registry.addComment("/c5/r1", new CommentImpl("we have to change this file."));
        registry.addComment("/c5/r2", new CommentImpl("replace this with a better one"));
        registry.addComment("/c5/r3", new CommentImpl("import all dependencies for this resource"));
    ...
    public void testCommentsAsResources() throws RepositoryException {
        Resource r1 = registry.newResource();
        String r1Content = "this is r1 content";
        r1.setContent(r1Content.getBytes());
        r1.setDescription("production ready.");
        ...
        try {
            registry.addComment("/c1/r1", new CommentImpl("this is used to test comments."));
            registry.addComment("/c1/r1", new CommentImpl("dummy resource."));
            registry.addComment("/c1/r1", new CommentImpl("simple test resource."));
        } catch (RepositoryException e) {
            fail("Valid tagging scenario failed.");
        }
        ...
        CommentImpl[] commentPaths = (CommentImpl[])comments.getContent();
        List<Object> commentStrings = new ArrayList<Object>();

        for (CommentImpl comment : commentPaths) {
            try {
    ...
    public void testRatingsAsResources() throws RepositoryException {
    ...
    public void testCombinedScenario() throws RepositoryException {
        ...
        registry.addComment("/r1", new CommentImpl("this is a test artifact."));
        registry.addComment("/c1", new CommentImpl("I don't agree with having this collection."));
        registry.addComment("/c1/r2", new CommentImpl("Is this a collection ;)"));
        registry.addComment("/c2",
                new CommentImpl("I can understand the purpose of this. Thanks."));
