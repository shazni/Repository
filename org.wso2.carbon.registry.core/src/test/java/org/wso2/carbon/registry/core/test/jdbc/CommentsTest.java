...
//            embeddedRegistryService = ctx.getEmbeddedRegistryService();
    ...
    public void testCommentQueryRootRegistry() throws RepositoryException {
        ...
        Collection qResults = registry.executeQuery(RepositoryConstants.CONFIG_REGISTRY_BASE_PATH +
    ...
    public void testCommentQueryNonRootRegistry() throws RepositoryException {
        ...
        localRepository.addComment("/test/comments/r1",
                new CommentImpl("commentXX1 on this resource :)"));
        localRepository.addComment("/test/comments/r1",
                new CommentImpl("commentXX2 on this resource :)"));
    ...
    public void testCommentDelete() throws RepositoryException {

        String r1Path = "/c1d1/c1";
        Collection r1 = registry.newCollection();
        registry.put(r1Path, r1);

        String c1Path = registry.addComment(r1Path, new CommentImpl("test comment1"));
        String c2Path = registry.addComment(r1Path, new CommentImpl("test comment2"));
