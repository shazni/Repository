...
public class MultiTenantTest extends BaseTestCase {
    ...
    public void testVirtualRoots() throws Exception {
        ...
        try {
            ...
            throw new RepositoryException("Error in adding a user", e);
        }
    ...
    public void testUserStores() throws RepositoryException {
        RealmConfiguration realmConfig = ctx.getRealmService().getBootstrapRealmConfiguration();
        ...
        try {
            ...
            throw new RepositoryException("Error in retrieving UserStoreManager.");
        }
        AuthorizationManager authorizationManager1;
        try {
            authorizationManager1 = userRealm1.getAuthorizationManager();
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in retrieving AuthorizationManager.");
        }
        ...
        try {
            ...
            throw new RepositoryException("Error in adding user user1t0.");
        }
        try {
            userStoreManager1.addUser("user2t0", "password", null, null, null);
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in adding user user2t0.");
        }
        try {
            userStoreManager1.addUser("user3t0", "password", null, null, null);
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in adding user user3t0.");
        }
        ...
        try {
            ...
            throw new RepositoryException("Error in adding user user4t0.");
        }
        try {
            userStoreManager1.addUser("user5t0", "password", null, null, null);
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in adding user user5t0.");
        }
        try {
            userStoreManager1.addUser("user6t0", "password", null, null, null);
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in adding user user6t0.");
        }
        ...
        try {
            ...
            throw new RepositoryException("Error in adding role role1t0.");
        }
        try {
            userStoreManager1.addRole("role2t0", null, null);
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in adding role role2t0.");
        }
        try {
            userStoreManager1.addRole("role3t0", null, null);
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in adding role role3t0.");
        }
//
...
//        } catch (UserStoreException e) {
//            throw new RepositoryException("Error in authorizing user1t0.");
//        }
//        try {
//            authorizationManager1.authorizeUser("user2t0", "/test2", ActionConstants.DELETE);
//        } catch (UserStoreException e) {
//            throw new RepositoryException("Error in authorizing user2t0.");
//        }
//        try {
//            authorizationManager1.authorizeUser("user2t0", "/test2", "authorize");
//        } catch (UserStoreException e) {
//            throw new RepositoryException("Error in authorizing user3t0.");
//        }
        ...
        try {
            ...
            throw new RepositoryException("Error in adding user user4t0 to role1t0 role.");
        }
        try {
            userStoreManager1.updateRoleListOfUser("user5t0", null, new String[]{"role2t0"});
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in adding user user5t0 to role2t0 role.");
        }
        try {
            userStoreManager1.updateRoleListOfUser("user6t0", null, new String[]{"role3t0"});
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in adding user user6t0 to role3t0 role.");
        }
        ...
        try {
            ...
            throw new RepositoryException("Error in authorizing role1t0.");
        }
        try {
            authorizationManager1.authorizeRole("role2t0", "/test2", ActionConstants.DELETE);
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in authorizing role2t0.");
        }
        try {
            authorizationManager1.authorizeRole("role3t0", "/test2", "authorize");
        } catch (UserStoreException e) {
            throw new RepositoryException("Error in authorizing role3t0.");
        }
        ...
        try {
            ...
            throw new RepositoryException("Error in checking authorizations.");
        }
    ...
    // Test adding tenants
    private void addTenants() throws RepositoryException,
    ...
    public void testClaims() throws RepositoryException, UserStoreException {
        // first we will fill the user store for tenant 0
        RealmConfiguration realmConfig = ctx.getRealmService().getBootstrapRealmConfiguration();
