...
//            embeddedRegistryService = ctx.getEmbeddedRegistryService();
    ...
    public void testCopyParentWithSymlink() throws RepositoryException {
        ...
        assertEquals("test R content", RepositoryUtils.decodeBytes(testRSym1Bytes));
        
        Resource testR2Sym1 = registry.get("/source/symC/r2");
        byte[] testR2Sym1Bytes = (byte[])testR2Sym1.getContent();
        assertEquals("test R2 content", RepositoryUtils.decodeBytes(testR2Sym1Bytes));
        ...
        assertEquals("test R content", RepositoryUtils.decodeBytes(testRSym2Bytes));

        Resource testR2Sym2 = registry.get("/source-copy/symC/r2");
        byte[] testR2Sym2Bytes = (byte[])testR2Sym2.getContent();
        assertEquals("test R2 content", RepositoryUtils.decodeBytes(testR2Sym2Bytes));
        ...
        assertEquals("test R updated content", RepositoryUtils.decodeBytes(testRBytes));

        testR2 = registry.get("/target/originalC/r2");
        byte[] testR2Bytes = (byte[])testR2.getContent();
        assertEquals("test R2 updated content", RepositoryUtils.decodeBytes(testR2Bytes));
    ...
    public void testSymlinkOrder() throws RepositoryException {
        ...
        registry.addComment("/Root_real/insiderB/insiderC/resource_real", new CommentImpl("cycle-cm1"));
        registry.addComment("/Root_real/insiderB/insiderC/resource_real", new CommentImpl("cycle-cm2"));
    ...
    public void testSymlinkOrder2() throws RepositoryException {
        ...
        registry.addComment("/myRoot/aaa/symlink2", new CommentImpl("cycle-cm1"));
        registry.addComment("/myRoot/aaa/symlink2", new CommentImpl("cycle-cm2"));
...
//    public void testSimilarCollectionNames() throws RepositoryException {
...
//    public void testSymlinkUpdates() throws RepositoryException {
//        Resource r = registry.newResource();
...
//    }
    ...
    public void testTransitiveSymLinks() throws RepositoryException {
        ...
        assertEquals("01", RepositoryUtils.decodeBytes((byte[])r.getContent()));

        // dynamically change /Root to each of the above collections
        registry.createLink("/Root", "/Root_02");
        r = registry.get("/Root/r1");
        assertEquals("02", RepositoryUtils.decodeBytes((byte[])r.getContent()));

        registry.createLink("/Root", "/Root_03");
        r = registry.get("/Root/r1");
        assertEquals("03", RepositoryUtils.decodeBytes((byte[])r.getContent()));
