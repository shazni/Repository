...
//            embeddedRegistryService = ctx.getEmbeddedRegistryService();
    ...
    public void testSuccessfulMultiOperationTransaction() throws RepositoryException {
        ...
        registry.addComment("/t2/r1", new CommentImpl("this is a good one"));
    ...
    public void testFailedMultiOperationTransaction() throws RepositoryException {
        ...
        registry.addComment("/t3/r1", new CommentImpl("this is a good one"));
    ...
    public void testNestedFailedMultiOperationTransaction() throws RepositoryException {
        ...
        registry.addComment("/t32/r1", new CommentImpl("this is a good one"));
