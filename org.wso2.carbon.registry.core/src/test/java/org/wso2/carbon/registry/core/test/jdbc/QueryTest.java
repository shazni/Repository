...
//            embeddedRegistryService = ctx.getEmbeddedRegistryService();
    ...
    public void testBackwardCompatibility() throws RepositoryException {
        ...
        rootRegistry.addComment("/test/comments/r1",
                new CommentImpl("backward-compatibility1 on this resource :)"));
        rootRegistry.addComment("/test/comments/r1",
                new CommentImpl("backward-compatibility2 on this resource :)"));
