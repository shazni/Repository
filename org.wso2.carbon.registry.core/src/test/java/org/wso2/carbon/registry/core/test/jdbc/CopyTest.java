...
//            embeddedRegistryService = ctx.getEmbeddedRegistryService();
    ...
    public void testResourceCopyWithComments() throws RepositoryException {

        Resource r1 = registry.newResource();
        r1.setProperty("test", "copy");
        r1.setContent("c");
        registry.put("/test/copy/c1/copy1", r1);
        registry.addComment("/test/copy/c1/copy1", new CommentImpl("comment1"));
        registry.addComment("/test/copy/c1/copy1", new CommentImpl("comment2"));
    ...
    public void testResourceCopyWithTags() throws RepositoryException {
