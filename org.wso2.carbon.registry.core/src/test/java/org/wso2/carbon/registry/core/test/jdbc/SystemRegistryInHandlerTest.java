...
//            embeddedRegistryService = ctx.getEmbeddedRegistryService();
    ...
    public void testNestedRegistryOperations() throws RepositoryException {
    	...
    	RegistryContext registryContext = InternalUtils.getRegistryContext(adminRegistry);
//        RegistryContext registryContext = ((EmbeddedRegistry) adminRegistry).getRegistryContext();
...
//                Repository repository = requestContext.getRepository();
            	...
            	Repository repository = InternalUtils.getRegistryContext(requestContext.getRegistry()).getRepository();
