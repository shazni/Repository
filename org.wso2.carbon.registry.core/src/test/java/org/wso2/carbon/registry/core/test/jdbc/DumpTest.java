...
//            embeddedRegistryService = ctx.getEmbeddedRegistryService();
    ...
    public void testResourceDump() throws RepositoryException, XMLStreamException {
        ...
        registry.addComment("/testDump", new CommentImpl("comment1"));
        registry.addComment("/testDump", new CommentImpl("comment2"));
        ...
        assertEquals(RepositoryUtils.decodeBytes((byte[])r.getContent()), "content 1");
    ...
    public void testCollectionDump() throws RepositoryException, XMLStreamException {
        ...
        registry.addComment("/testDumpC", new CommentImpl("comment1"));
        registry.addComment("/testDumpC", new CommentImpl("comment2"));
        ...
        assertEquals(RepositoryUtils.decodeBytes((byte[])r2.getContent()), "content child2R");
    }
    ...
    public void testRootDump() throws RepositoryException, XMLStreamException {
        ...
        registry.addComment("/", new CommentImpl("comment1"));
        registry.addComment("/", new CommentImpl("comment2"));
    ...
    public void testRootRestore() throws RepositoryException, XMLStreamException {
        ...
        registry.addComment("/testSomewhereElse1", new CommentImpl("comment3"));
        registry.addComment("/testSomewhereElse1", new CommentImpl("comment4"));
    ...
    public void testNewRestore() throws RepositoryException, XMLStreamException {
        ...
        registry.addComment("/testSomewhereElse3", new CommentImpl("comment3"));
        registry.addComment("/testSomewhereElse3", new CommentImpl("comment4"));
    ...
    public void testAbsoluteAssociationPath() throws Exception {
        assertEquals("/abc", RepositoryUtils.getAbsoluteAssociationPath("../abc", "/lm/pqr"));
        assertEquals("/abc/def",
                RepositoryUtils.getAbsoluteAssociationPath("../../../abc/def", "/lm/pqr/b/boo"));
        assertEquals("/abc/hag/def",
                RepositoryUtils.getAbsoluteAssociationPath("../hag/def", "/abc/boo/lm"));
        assertEquals("/abc", RepositoryUtils.getAbsoluteAssociationPath("abc", "/pqr"));
        assertEquals("/bloom/squid/abc",
                RepositoryUtils.getAbsoluteAssociationPath("squid/abc", "/bloom/squid2"));
        assertEquals("/abc", RepositoryUtils.getAbsoluteAssociationPath("abc", "/abc"));

        // go beyond cases
        assertEquals("//abc", RepositoryUtils.getAbsoluteAssociationPath("../../abc", "/lm/pqr"));
        assertEquals("///abc", RepositoryUtils.getAbsoluteAssociationPath("../../../abc", "/lm/pqr"));
        assertEquals("////abc",
                RepositoryUtils.getAbsoluteAssociationPath("../../../../abc", "/lm/pqr"));
    }


    public void testRelativeAssociationPath() throws Exception {
        assertEquals("../abc", RepositoryUtils.getRelativeAssociationPath("/abc", "/lm/pqr"));
        assertEquals("../../../abc/def",
                RepositoryUtils.getRelativeAssociationPath("/abc/def", "/lm/pqr/b/boo"));
        assertEquals("../hag/def",
                RepositoryUtils.getRelativeAssociationPath("/abc/hag/def", "/abc/boo/lm"));
        assertEquals("abc", RepositoryUtils.getRelativeAssociationPath("/abc", "/pqr"));
        assertEquals("squid/abc",
                RepositoryUtils.getRelativeAssociationPath("/bloom/squid/abc", "/bloom/squid2"));
        assertEquals("abc", RepositoryUtils.getRelativeAssociationPath("/abc", "/abc"));

        assertEquals("../../abc", RepositoryUtils.getRelativeAssociationPath("//abc", "/lm/pqr"));
        assertEquals("../../../abc", RepositoryUtils.getRelativeAssociationPath("///abc", "/lm/pqr"));
        assertEquals("../../../../abc",
                RepositoryUtils.getRelativeAssociationPath("////abc", "/lm/pqr"));
    }
