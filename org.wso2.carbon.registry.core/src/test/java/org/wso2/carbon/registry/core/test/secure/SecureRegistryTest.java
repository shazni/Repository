...
//        }
    ...
    public void testUserBasedAuthorization() throws RepositoryException {
        ...
        try {
            barRegistry.get("/r1");
        } catch (RepositoryAuthException e) {
    ...
    public void testRoleBasedAuthorization() throws RepositoryException {
