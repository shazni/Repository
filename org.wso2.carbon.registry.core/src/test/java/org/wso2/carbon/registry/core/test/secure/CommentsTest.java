    ...
    public void testCommentDelete() throws Exception {
        ...
        String c1 =
                adminReg.addComment("/CRTest/r1",
                        new CommentImpl("administrator's comment on /CRTest/r1"));
        ...
        String c2 =
                adminReg.addComment("/CRTest/r2",
                        new CommentImpl("administrator's comment on /CRTest/r2"));

        String c3 =
                cu1Reg.addComment("/CRTest/r1", new CommentImpl("cu1's comment on /CRTest/r1"));

        String c4 =
                cu1Reg.addComment("/CRTest/r2", new CommentImpl("cu1's comment on /CRTest/r2"));
