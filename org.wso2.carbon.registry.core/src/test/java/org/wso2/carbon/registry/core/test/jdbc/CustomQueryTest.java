...
//            embeddedRegistryService = ctx.getEmbeddedRegistryService();
    ...
    public void testQueryAsParameter() throws RepositoryException {
        Resource r1 = registry.newResource();
        r1.setContent("r1 content");
        registry.put("/test/comments/r1", r1);

        registry.addComment("/test/comments/r1", new CommentImpl("commentXX1 on this resource :)"));
        registry.addComment("/test/comments/r1", new CommentImpl("commentXX2 on this resource :)"));
    ...
    public void testCustomQueryResultsOrderForComments() throws RepositoryException {

        Resource r1 = registry.newResource();
        r1.setContent("r1x content");
        registry.put("/test/comments/r1x", r1);

        registry.addComment("/test/comments/r1x", new CommentImpl("commentXX1 on this resource :)"));
        registry.addComment("/test/comments/r1x", new CommentImpl("commentXX2 on this resource :)"));
        registry.addComment("/test/comments/r1x", new CommentImpl("commentXX3 on this resource :)"));
        registry.addComment("/test/comments/r1x", new CommentImpl("a new test comment"));
        ...
        assertEquals("Comment query result is invalid",
                ((CommentImpl) registry.get(qPaths[0])).getText(),
                "a new test comment");
        assertEquals("Comment query result is invalid",
                ((CommentImpl) registry.get(qPaths[1])).getText(),
                "commentXX3 on this resource :)");
        assertEquals("Comment query result is invalid",
                ((CommentImpl) registry.get(qPaths[2])).getText(),
                "commentXX2 on this resource :)");
        assertEquals("Comment query result is invalid",
                ((CommentImpl) registry.get(qPaths[3])).getText(),
        ...
        assertTrue("Comment query should return Comment objects as results",
                qResult instanceof CommentImpl);

        CommentImpl c1 = (CommentImpl) qResult;
        ...
        registry.addComment("/test/comments/r2", new CommentImpl("commentXX1 on this resource :)"));
        registry.addComment("/test/comments/r2", new CommentImpl("commentXX2 on this resource :)"));
        registry.addComment("/test/comments/r2", new CommentImpl("commentXX3 on this resource :)"));
        registry.addComment("/test/comments/r2", new CommentImpl("a new test comment"));
