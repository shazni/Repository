...
public interface RatingsDAO {
     ...
     *
     * @throws RepositoryException if some error occurs while adding ratings
     */
     ...
     *
     * @throws RepositoryException if some error occurs while updating the rating.
     */
     ...
     */
    int getRateID(ResourceImpl resourceImpl, String userID) throws RepositoryException;
     ...
     */
    float getAverageRating(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     */
    RatingDO getRatingDO(ResourceImpl resourceImpl, String userID) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurs while getting the rating.
     */
    int getRating(ResourceImpl resourceImpl, String userID) throws RepositoryException;
     ...
     * @param resourceImpl the resource.
     *
     * @throws RepositoryException if some error occurs while removing ratings.
     */
    void removeRatings(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException if some error occurs while removing ratings.
     */
    void removeRating(ResourceImpl resourceImpl, int rateID) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurs while getting the rating.
     */
    RatingDO[] getResourceRatingDO(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurs while getting the rating.
     */
    String[] getRatedUserNames(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     */
    void moveRatings(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException;
