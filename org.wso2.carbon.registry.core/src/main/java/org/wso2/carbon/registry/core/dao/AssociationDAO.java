...
public interface AssociationDAO {
     ...
     *
     * @throws RepositoryException if some error occurs while adding associations
     */
     ...
     * @param associationType the type of the association
     *
     * @throws RepositoryException if some error occurs while removing associations
     */
     ...
     * @throws RepositoryException if some error occurs while getting all associations
     */
     ...
     * @throws RepositoryException if some error occurs while getting associations of a given type
     */
     ...
     *
     * @throws RepositoryException if an error occurs while
     */
    void replaceAssociations(String oldPath, String newPath) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurs while
     */
    void removeAllAssociations(String resourcePath) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurs while
     */
    void copyAssociations(String fromPath, String toPath) throws RepositoryException;
}
