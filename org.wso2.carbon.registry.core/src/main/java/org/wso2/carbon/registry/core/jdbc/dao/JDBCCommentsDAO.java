...
public class JDBCCommentsDAO implements CommentsDAO {
    ...
    public int addComment(ResourceImpl resource, String userID, CommentImpl comment)
    ...
    public void copyComments(ResourceImpl sourceResource, ResourceImpl targetResource)
        ...
        CommentImpl[] comments = getComments(sourceResource);
    ...
    public void updateComment(long commentId, String text) throws RepositoryException {
    ...
    public void deleteComment(long commentId) throws RepositoryException {
    ...
    public void removeComments(ResourceImpl resource) throws RepositoryException {
        ...
        CommentImpl[] comments = getComments(resource);
        try {
            String sql1 =
                    "DELETE FROM REG_RESOURCE_COMMENT WHERE REG_COMMENT_ID = ? AND REG_TENANT_ID=?";
            ps1 = conn.prepareStatement(sql1);
    ...
    public CommentImpl getComment(long commentID, String resourcePath) throws RepositoryException {
        ...
        try {
            ...
            if (result.next()) {
                String commentPath = resourcePath + RepositoryConstants.URL_SEPARATOR + "comments:" +
                ...
                comment.setParentPath(resourcePath + RepositoryConstants.URL_SEPARATOR + "comments");
            }
            return comment;
    ...
    public CommentImpl[] getComments(ResourceImpl resource) throws RepositoryException {

        JDBCDatabaseTransaction.ManagedRegistryConnection conn =
                JDBCDatabaseTransaction.getConnection();

        List<CommentImpl> commentList = new ArrayList<CommentImpl>();
        PreparedStatement s = null;
        ...
        try {
            ...
            while (results.next()) {
                ...
                String commentPath = path + RepositoryConstants.URL_SEPARATOR + "comments:" +
                        results.getInt(DatabaseConstants.ID_FIELD);
                comment.setPath(commentPath);
                comment.setCommentPath(commentPath);
                comment.setParentPath(path + RepositoryConstants.URL_SEPARATOR + "comments");
        ...
        return commentList.toArray(new CommentImpl[commentList.size()]);
    }
    ...
    public String[] getResourcePathsOfComments(Long[] commentIDs, Connection conn)
        ...
        try {
            ...
            while (results.next()) {
                ...
                if (path != null) {
                    String commentPath =
                            path + RepositoryConstants.URL_SEPARATOR + "comments:" + commentID;
    ...
    public ResourceImpl getResourceWithMinimumData(String path) throws RepositoryException {
        return InternalUtils.getResourceWithMinimumData(path, resourceDAO, false);
    }
    ...
    private List<Long> getCommentIds(long regVersionId) throws RepositoryException {
