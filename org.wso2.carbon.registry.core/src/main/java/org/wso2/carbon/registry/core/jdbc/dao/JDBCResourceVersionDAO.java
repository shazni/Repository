        ...
        if (StaticConfiguration.isVersioningProperties()) {
            ...
            if (linkRestoration != null) {
                ...
                if (parts.length == 4) {
                    ...
                    InternalUtils.registerHandlerForRemoteLinks(RegistryContext.getBaseInstance(),
                            parts[0], parts[1], parts[2], parts[3]);
                } else if (parts.length == 3) {
                	InternalUtils.registerHandlerForSymbolicLinks(RegistryContext.getBaseInstance(),
