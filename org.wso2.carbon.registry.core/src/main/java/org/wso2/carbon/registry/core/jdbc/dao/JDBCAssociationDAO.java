...
public class JDBCAssociationDAO implements AssociationDAO {
    ...
    public void replaceAssociations(String oldPath, String newPath) throws RepositoryException {
    ...
    public void removeAllAssociations(String resourcePath) throws RepositoryException {
    ...
    public void copyAssociations(String fromPath, String toPath) throws RepositoryException {
        PreparedStatement ps = null;
        ResultSet result = null;
        try {
            JDBCDatabaseTransaction.ManagedRegistryConnection conn =
