...
public class JDBCTagsVersionDAO extends JDBCTagsDAO implements TagsDAO {
     ...
     */
    public String[] getTags(ResourceImpl resourceImpl) throws RepositoryException {
     ...
     */
    public List<TaggingDO> getTagDOs(ResourceImpl resourceImpl) throws RepositoryException {
     ...
     */
    public List getPathsWithAnyTag(String[] tags) throws RepositoryException {
     ...
     */
    public long getTagCount(ResourceImpl resourceImpl, String tag) throws RepositoryException {
     ...
     */
    public Tag[] getTagsWithCount(ResourceImpl resourceImpl) throws RepositoryException {
     ...
     */
    public void moveTags(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException {
