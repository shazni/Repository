...
public class MediaTypesUtils {
    ...
    private static final String MIME_TYPE_COLLECTION = RepositoryConstants.GOVERNANCE_COMPONENT_PATH +
            "/media-types";
...
//        }
        ...
        String resourcePath = MIME_TYPE_COLLECTION + RepositoryConstants.PATH_SEPARATOR +
        ...
        if (!configSystemRegistry.resourceExists(resourcePath + RepositoryConstants.PATH_SEPARATOR +
            ...
            resource.setDescription("This resource contains the media Types associated with " +
                    ...
                    "Types.");
            configSystemRegistry.put(resourcePath + RepositoryConstants.PATH_SEPARATOR +
                    COLLECTION_MIME_TYPE_INDEX, resource);
        } else {
            resource = configSystemRegistry.get(resourcePath + RepositoryConstants.PATH_SEPARATOR +
                    COLLECTION_MIME_TYPE_INDEX);
        }
...
//        registryContext.setCollectionMediaTypes(mediaTypeString);
        ...
        RepositoryUtils.setCollectionMediaTypes(mediaTypeString);
...
//            registryContext.setResourceMediaTypes(mediaTypeString);
            ...
            RepositoryUtils.setResourceMediaTypes(mediaTypeString);
            return mediaTypeString;
        }
...
//        String mediaTypes = getResourceMediaTypeMappings(RegistryContext.getBaseInstance());
        String mediaTypes = RepositoryUtils.getResourceMediaTypes();
        if (mediaTypes == null) {
