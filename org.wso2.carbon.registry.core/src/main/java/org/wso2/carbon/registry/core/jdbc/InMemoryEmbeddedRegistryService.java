...
public class InMemoryEmbeddedRegistryService extends EmbeddedRegistryService {
     ...
     * Default constructor
     *
     * @throws RepositoryException if construction fails.
     */
    public InMemoryEmbeddedRegistryService() throws RepositoryException {
        realmService = new InMemoryRealmService();
        registryContext = RegistryContext.getBaseInstance(realmService, this);
     ...
     */
    public InMemoryEmbeddedRegistryService(InputStream configStream) throws RepositoryException {
        realmService = new InMemoryRealmService();
        registryContext = RegistryContext.getBaseInstance(configStream, realmService, this);
        registryContext.setSetup(true);
        registryContext.selectDBConfig("h2-db");
        
        super.init(registryContext);
//        super.configure(realmService);
    }
