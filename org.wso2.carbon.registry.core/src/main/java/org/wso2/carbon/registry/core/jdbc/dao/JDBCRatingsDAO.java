...
public class JDBCRatingsDAO implements RatingsDAO {
    ...
    public void removeRating(ResourceImpl resourceImpl , int ratingID) throws RepositoryException {
    ...
    public int getRating(ResourceImpl resourceImpl, String userID) throws RepositoryException {
    ...
    public void removeRatings(ResourceImpl resourceImpl) throws RepositoryException {
    ...
    private List<Long> getRatingIds(long regVersionId) throws RepositoryException {
