...
//        	tempResource = (requestContext.getRegistry()).get(this.mountPoint);
        	tempResource = ((EmbeddedRegistry) requestContext.getRegistry()).getRepository().get(this.mountPoint);
...
//        registerHandler(requestContext.getSystemRegistry());
    ...
    private void registerHandler(Registry registry) throws RepositoryException {
        if (!isHandlerRegistered) {
            InternalUtils.addMountEntry(registry, RegistryContext.getBaseInstance(), mountPoint,
