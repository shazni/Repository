...
public class RegistryClientUtils {
    ...
    public static void importToRegistry(File file, String path, Registry registry)
        ...
        try {
            if (file == null || path == null) {
                throw new RepositoryException("The values of the mandatory parameters, file and " +
                        "path cannot be null.");
            }
            processImport(file, path, registry);
        } catch (Exception e) {
            log.error("Failed to import to registry", e);
            throw new RepositoryServerException("Failed to import to registry", e);
        }
    }
    ...
    public static void exportFromRegistry(File toFile, String path, Registry registry)
        ...
        try {
            ...
            throw new RepositoryServerException("Failed to export from registry", e);
        }
    }
    ...
    private static void processExport(String fromPath,
                                      File toFile,
                                      Registry registry,
                                      boolean useOriginal) throws RepositoryException {
        ...
        if (resource != null) {
            ...
            if (resource instanceof Collection) {
                ...
                try {
                    ...
                    throw new RepositoryServerException("An error occurred while creating the file: " +
