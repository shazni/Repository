...
public class RemoteResourceImpl extends ResourceImpl {
    ...
    public Object getContent() throws RepositoryException {
        ...
        if (content != null) {
            if (content instanceof String) {
                ...
                return RepositoryUtils.encodeString((String) content);
            }
            return content;
        }
        ...
        if(!contentModified){
            try {
                ...
                throw new RepositoryServerContentException("Couldn't get content stream", e);
            }
        }
        return null;
    ...
    private InputStream getContentStreamFromURL() throws RepositoryException {
        ...
        if (contentURL != null) {
            try {
                ...
                throw new RepositoryServerContentException("Couldn't open stream to source URL " + contentURL, e);
            }
        }
