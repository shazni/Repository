...
public class JDBCTagsDAO implements TagsDAO {
    ...
    public String[] getPathsWithTag(String tag, Connection conn) throws RepositoryException {
    ...
    private List<Long> getTagIds(long regVersionId) throws RepositoryException {
