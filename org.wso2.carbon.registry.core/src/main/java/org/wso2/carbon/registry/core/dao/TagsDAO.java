...
public interface TagsDAO {
     ...
     *
     * @throws RepositoryException if some error occurs while adding a tag
     */
     ...
     *
     * @throws RepositoryException if some error occurs while adding tags
     */
     ...
     *
     * @throws RepositoryException if some error occurs while copying tags
     */
     ...
     * @throws RepositoryException if some error occurs while checking whether a tag exists.
     */
     ...
     *
     * @throws RepositoryException if an error occurred while removing the tag.
     */
     ...
     * @throws RepositoryException if an error occurs while getting the tag names.
     */
    String[] getTags(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurs while getting the tagging data objects.
     */
    List<TaggingDO> getTagDOs(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     */
    List getPathsWithAnyTag(String[] tags) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurred while getting the number of tags.
     */
    long getTagCount(ResourceImpl resourceImpl, String tag) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurred while getting tags.
     */
    Tag[] getTagsWithCount(ResourceImpl resourceImpl) throws RepositoryException;
     ...
     * @throws RepositoryException if an error occurs while getting the tagging.
     */
     ...
     *
     * @return the tagging data objects.
     * @throws RepositoryException if an error occurs while getting the taggings.
     */
     ...
     *
     * @throws RepositoryException if some error occurs while moving tags
     */
    void moveTags(ResourceIDImpl source, ResourceIDImpl target) throws RepositoryException;
     ...
     * @param target the target resource.
     *
     * @throws RepositoryException if some error occurs while moving tag paths
     */
