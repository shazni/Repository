...
public class Utils {
     ...
     */
    public static UserRegistry getRegistry(HttpServletRequest request) throws RepositoryException {
        String username = null;
        String password = null;
        UserRegistry registry =
                (UserRegistry) request.getSession().getAttribute(
                        RepositoryConstants.ROOT_REGISTRY_INSTANCE);
        ...
        if (registry == null) {
            ...
            if (username != null) {
                ...
                if (!registryInvalidated) {
                    request.getSession().setAttribute(RepositoryConstants.ROOT_REGISTRY_INSTANCE,
                            registry);
                }
            } else {
     ...
     * @throws RepositoryException if the embedded registry service is not available.
     */
    public static EmbeddedRegistryService getEmbeddedRegistryService() throws RepositoryException {
