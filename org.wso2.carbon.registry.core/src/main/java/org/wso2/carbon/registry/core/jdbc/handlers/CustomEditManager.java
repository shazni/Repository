...
public class CustomEditManager {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response)
        ...
        String processorKey = request.getParameter(/*RepositoryConstants.*/ InternalConstants.CUSTOM_EDIT_PROCESSOR_KEY);
        ...
        String viewType = request.getParameter(/*RepositoryConstants.*/ InternalConstants.VIEW_TYPE);
        ...
        if (/*RepositoryConstants.*/ InternalConstants.EDIT_VIEW_TYPE.equals(viewType)) {
            path = request.getParameter("resourcePath");
            responseSent = editProcessor.processEditContent(path, viewKey, request, response);

        } else if (/*RepositoryConstants.*/ InternalConstants.NEW_VIEW_TYPE.equals(viewType)) {
